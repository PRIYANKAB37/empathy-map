...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
  ...
  *{
  ...
  height:50px;
  width:100%;
  background-color:rgb(85, 144, 207);
  color:white;
  border-radius:4px;
  font-weight:bold;
  }
...
<section class="form topsec">
   ...
   <div class="container">
       <div class="row no-gutters">
         ...
         <div class="col-lg-5">
            <img src="images/pngwing.com.png" class="img-fluid" alt="" width="600px" height="600px">
         </div>
         ...
         <div class="col-lg-7 mainbox">
            ...
            <h3>Add New User</h3>
               <form action="addUser" >
                ...
                <div class="form-row">
                  <div class="col-lg-7">
                    <input type="text" placeholder="Date Of Birth" name="name" class="form-control in1"  required>
                 </div>
               </div>
                ...
                <div class="form-row">
                  <div class="col-lg-7">
                    <input type="number" placeholder="Mobile Number" name="number" class="form-control in1"  required>
                  </div>
                </div>
